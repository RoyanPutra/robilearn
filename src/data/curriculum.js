...
export const CURRICULUM = {
  math_dasar: [
    ...
    stage('md_exam','Ujian Akhir','🏆','Ujian semua kemampuan',[lv('md_exam_l0','Ujian','exam','10 soal campuran','mixed_math_dasar',{count:10})],true),
  ],
  math_menengah: [
  ...
  bahasa_tinggi: [
    ...
    stage('bt_s2','Cerita Pendek','📗','Pahami isi cerita',[
      lv('bt_s2_l0','Tingkat 1','easy','Tebak tokoh', 'tebak',       {count:5}),
      lv('bt_s2_l1','Tingkat 2','mid', 'Tebak lanjut','tebak',       {count:6}),
      lv('bt_s2_l2','Tingkat 3','hard','Campuran',    'mixed_bahasa',{count:7}),
    ]),
    stage('bt_s3','Kosa Kata Lanjut','🗂️','Level tertinggi',[
      lv('bt_s3_l0','Tingkat 1','easy','Kata mudah', 'lawan_kata', {count:5}),
      lv('bt_s3_l1','Tingkat 2','mid', 'Kata sedang','sinonim',    {count:6}),
      lv('bt_s3_l2','Tingkat 3','hard','Kata lanjut','mixed_bahasa',{count:7}),
    ]),
